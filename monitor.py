...
TARGETS: list[dict] = [
    ...
    {"name": "일반예매",   "path": "/ticket/general",        "category": "티켓",   "must_contain": ["<html"],                   "data_selector": "[class*='ticket'], a[href*='ticket']", "data_min": 3, "data_label": "예매 요소"},
    {"name": "시즌권",     "path": "/ticket/seasonGuide",    "category": "티켓",   "must_contain": ["<html"],                   "data_selector": "img",                             "data_min": 3,  "data_label": "안내 이미지"},
    {"name": "계열사 예매", "path": "/ticket/affiliate",     "category": "티켓",   "must_contain": ["<html"],                   "data_selector": "img",                             "data_min": 3,  "data_label": "이미지"},
    {"name": "MVP투표",    "path": "/fan/mvp",               "category": "팬",     "must_contain": ["<html"],                   "data_selector": "[class*='vote']",                 "data_min": 3,  "data_label": "투표 항목"},
    {"name": "응원단",     "path": "/fan/cheers",            "category": "팬",     "must_contain": ["<html"],                   "data_selector": "[class*='cheer']",                "data_min": 5,  "data_label": "응원 콘텐츠"},
